...
import rong.carissima.DEMO.DemoMainActivity;
import rong.carissima.R;
import rong.carissima.application.DemoApplication;
import rong.carissima.util.Constant;
import rong.carissima.util.HttpRequest;
 ...
 * @author Lemon
 */
public class AboutCarissimaActivity extends BaseActivity implements OnClickListener, OnLongClickListener, OnBottomDragListener {
	...
	public static Intent createIntent(Context context) {
		return new Intent(context, AboutCarissimaActivity.class);
	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.about_carissima_activity, this);
